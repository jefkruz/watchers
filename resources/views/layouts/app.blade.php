    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a href="{{route('register')}}" class="ai-icon" aria-expanded="false">
                        <i class="fas fa-user-plus"></i>
                        <span class="nav-text">Become An Influencer</span>
                    </a>
                </li>

                <li><a href="{{route('signIn')}}" class="ai-icon" aria-expanded="false">
                        <i class="fas fa-tv"></i>
                        <span class="nav-text">Participate</span>
                    </a>
                </li>

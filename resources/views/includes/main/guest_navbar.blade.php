                                ...
                                <ul class="timeline">
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted" href="#">
                                            <span>{{date('jS F, Y ', strtotime(session('guest.created_at'))) }}</span>
                                            <h6 class="mb-0">Welcome! <strong class="text-danger">{{ucwords(session('guest.name'))}}</strong> joined YLWSIN.</h6>
                                        </a>
                                    </li>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="" role="button" data-bs-toggle="dropdown">
                            <div class="header-info">
                                <span class="text-black">{{ucwords(session('guest.name'))}}</span>
                                <p class="fs-12 mb-0">{{strtoupper('PARTICIPANT')}}</p>
                            </div>

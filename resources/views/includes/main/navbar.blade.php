                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380 ps">
                                <ul class="timeline">
                                    ...
                                    <li>
                                        ...
                                        <div  class="timeline-panel {{($notification->isNew()) ? 'active' : ''}}">
                                                ...
                                                <div  class="timeline-panel">
                                                    <div class="media me-2">
                                                        ...
                                                        @if(session('user')->avatar != '')
                                                            <img src="{{asset( 'avatar/'.session('user')->avatar)}}" width="50" alt=""/>
                                                        @else
                            ...
                            <a class="all-notification" href="{{route('notifications')}}">See all notifications <i class="ti-arrow-right"></i></a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="" role="button" data-bs-toggle="dropdown">
                            ...
                            @if(session('user')->avatar != '')
                            <img src="{{asset( 'avatar/'.session('user')->avatar)}}" width="20" alt=""/>
                            @else
